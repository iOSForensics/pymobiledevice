...
if __name__ == "__main__":
    ...
    setup(
        ...
        license="Copyright(c)2010-2021 Mathieu Renard All Rights Reserved. ",
        entry_points={'console_scripts': ['pyafc=pymobiledevice.afc:main',
'pyappsmanager=pymobiledevice.apps:main',
...
'pypcapd=pymobiledevice.pycapd:main',
